...
import com.ashokjeph.dualdb.repositories.primary_repository.UserRepository;
...
//            log.info("[JwtTokenUtil] Token expired socket notification sent for user ID: {}", user.getId());
        } else {
//            log.warn("[JwtTokenUtil] User not found for email: {}. Socket notification not sent.", email);
        }
    }
}
