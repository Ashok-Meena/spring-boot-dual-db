//package ai.funder.server.config;
//
...
//        basePackages = {"com.ashokjeph.dualdb.repositories.secondary_repository"},
...
//                .packages("ai.funder.server.entity") // entities for secondary datasource
